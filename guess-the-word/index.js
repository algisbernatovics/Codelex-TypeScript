...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var listOfWords, word, wordParts, targetWord, guesses, maxGuesses, response, letterPosition;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                listOfWords = ["terminators", "klara", "grieta", "algis"];
            ...
            case 3:
                if (word != targetWord.join("")) {
                    console.log("Wrong! The word waz:" + word);
                }
                return [2 /*return*/];
        }
    });
