...
const fetchExchangeRates = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return exchangeRates; /////ggggggggggggggg
});
const app = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(`FROM (${response.fromCurrency.symbol}) with amount of ${response.amount} we got ${btcValue} BTC that is equal to ${response.toCurrency.symbol} with amount ${endCurrencyValue}.`);
});
app();
