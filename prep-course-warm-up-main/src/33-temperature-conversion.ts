...
const fahrenheitToCelsius = (fahrenheit: number): string => (((fahrenheit - 32) * 5 / 9)).toFixed(1)

const celsiusToFahrenheit = (celsius: number): string => ((celsius * 9.5) + 32).toFixed(1)
